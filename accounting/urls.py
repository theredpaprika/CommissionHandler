...
from .views import (new_commission_period_view, account_search_view, account_create_view, account_view, journal_search_view, journal_view,
                           journal_create_view, account_subtype_create_view, journal_create_cash_topup_view)

app_name = 'accounting'

urlpatterns = [
    path('commissionperiod/new', new_commission_period_view),
